...
const mockInactiveEmployees: Employee[] = [
    {
        id: 'EMP-101',
...
export function EmployeesInactive({
    employees = mockInactiveEmployees,
    isLoading = false,
    itemsPerPage = ITEMS_PER_PAGE,
    onEdit,
    onView,
}: EmployeesInactiveProps) {
                                ...
                                <TableCell>
                                    <StatusDropdown
                                        ...
                                        onStatusChange={(newStatus) => {
                                            // TODO: wire to API (e.g. PATCH /employees/{id}/status)
